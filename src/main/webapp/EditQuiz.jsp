		...
		<div class="container-fluid page-body-wrapper">
			...
			<nav class="sidebar sidebar-offcanvas" id="sidebar">
				<ul class="nav">
					...
					<li class="nav-item"><a class="nav-link" href="NewQuiz.jsp">
							<i class="icon-paper menu-icon"></i> <span class="menu-title">Add
								Quiz</span>
					</a></li>

					<li class="nav-item"><a class="nav-link"
						href="ListQuizServlet"> <i class="icon-paper menu-icon"></i> <span
							class="menu-title">List Quiz</span>
					</a></li>
						...
						<div class="col-lg-6 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<form class="pt-3" method="post" action="UpdateQuizServlet">
										...
										<div class="form-group">
											<input type="text" class="form-control form-control-lg"
												...
												name="totalQuestion" value="${quiz.totalQuestion}">
										</div>

										<div class="form-group">
											<input type="text" class="form-control form-control-lg"
												id="exampleInputUsername1" placeholder="Point Per Question"
												name="perQuestionPoint" value="${quiz.perQuestionPoint}">
										</div>

										<div>
											IsNegative : <input type="checkbox" name="negative"
												value="true" ${quiz.negative?"checked=checked":"" }>
										</div>

										<div class="form-group">
											<input type="text" class="form-control form-control-lg"
												id="exampleInputUsername1" placeholder="MinusPoint"
												name="minusPoint" value="${quiz.minusPoint}">
										</div>
										...
										<div class="form-group">
											<input type="date" class="form-control form-control-lg"
												...
												name="startDate" value="${quiz.startDate}">
										</div>
										...
										<div class="mt-3 d-grid gap-2">
											<button type="submit"
												class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">UPDATE QUIZ</button>
										</div>
